...
const Footer = () => {
  ...
  return (
    <div className='bg-[#151515] pb-6 flex flex-col items-center w-full'>
      <div className='hidden sm:block w-full'>
        <div className="flex flex-col items-center">
          ...
          <div className='relative md:mt-[11rem] mb-[6rem]  flex flex-col justify-center items-center'>
            <div className=' md:absolute -left-[16rem] -top-[7rem]'>
        ...
        <div className='flex justify-between items-center px-[10%] w-full mt-6'>
